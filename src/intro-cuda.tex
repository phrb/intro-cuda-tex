...
\begin{frame}
    ...
    \end{center}
    Os \emph{pdf}s com as aulas e todo o código fonte estão no \alert{GitHub}:
...
\begin{frame}
    ...
    disponíveis em \url{github.com/phrb/intro-cuda}:
    \begin{itemize}
        \item \url{src/cuda-samples/0_Simple}
        \item \url{src/cuda-samples/0_Simple/vectorAdd}
        \item \url{src/cuda-samples/5_Simulations/fluidsGL}
        \item \url{src/cuda-samples/5_Simulations/oceanFFT}
        \item \url{src/cuda-samples/5_Simulations/smokeParticles}
...
\section{Análise e Otimização de Aplicações CUDA}

\subsection{Análise de Aplicações CUDA}
...
\begin{frame}
    ...
    \pause
    \begin{itemize}
        \item Quais são os \alert{hotspots} (gargalos)
            \pause
...
\subsection{Computação Heterogênea: GPUs}

\begin{frame}
    \frametitle{Computação Heterogênea: \textit{host} e \textit{device}}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Frequência e duração de \alert{chamadas de função}: \textit{On-CPU}
            \pause
        \item Tempo \alert{ocioso}: \textit{Off-CPU}
    \end{itemize}
\end{frame}
...
\subsection{Otimização de Aplicações CUDA}

\section{Encontrando Erros em Applicações CUDA}

\subsection{Debuggers}

\begin{frame}
    \frametitle{\textit{Debuggers}}
    \textit{Debuggers}:
    \begin{itemize}
